...
def performance_analysis():
    ...
    print(f"{'Size>10':<10} {'IS Time(ms)':>14} {'BS Time(ms)':>14}")
    print(f"{'IS Comparisons':>16} {'BS Comparisons':>16}")
    print("-" * 75)
    ...
    for size in sizes:
        ...
        # FIXED: Added 'print' and removed the extra ')'
        print(f"{size:<10} {is_time:>14.4f} {bs_time:>14.4f}")
        print(f"{comp_is:>16} {comp_bs:>16}")
